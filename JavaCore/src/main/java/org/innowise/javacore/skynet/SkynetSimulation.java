...
public class SkynetSimulation {
  ...
  public void simulate() {
    ...
    Faction world = new Faction("World", daysCount, partsStorage, state, lock, 0, cycleCondition,
        maxDetailsTaken);
    Faction wednesday = new Faction("Wednesday", daysCount, partsStorage, state, lock, 1,
        cycleCondition, maxDetailsTaken);
